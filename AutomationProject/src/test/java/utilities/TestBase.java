...
public class TestBase {
	...
	public static String takeScreenshot(WebDriver driver) {
		try {
			...
			dest = "C:\\Users\\vishu\\Documents\\Project Automation\\AutomationProject\\Screenshot\\" + time + ".png"; 
	...
	public void Reportsetup()
	{
		try
		{
			...
			report=new ExtentReports("C:\\Users\\vishu\\Documents\\Project Automation\\AutomationProject\\TestReport\\Report.html",true);
	...
	public WebDriver startBrowser(String browsername,String url)
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "D://tools//drivers//chromedriver.exe");
